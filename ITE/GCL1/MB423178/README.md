...
* **Instalacja JDK 17 oraz Git:**
    ![Instalacja środowiska](lab3_1.png)
* **Klonowanie repozytorium:**
    ![Klonowanie PetClinic](lab3_2.png)
* **Budowanie aplikacji (mvnw package):**
    ![Build lokalny](lab3_3.png)
* **Uruchomienie testów lokalnie:**
    ![Testy lokalne](lab3_4.png)
...
![Docker Compose Start](lab3_12.png)
![Docker Compose Success](lab3_13.png)
