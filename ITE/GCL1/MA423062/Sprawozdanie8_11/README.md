...
![Plik inventory z hostem docelowym używanym przez Ansible.](lab8_ansible_jenkins/inventory.png)

*Rys. 1. Plik inventory z hostem docelowym używanym przez Ansible.*

![Test połączenia Ansible ping zakończony poprawną odpowiedzią hosta.](lab8_ansible_jenkins/ansibleping.png)
...
![Poprawne wykonanie playbooka i podsumowanie zadań Ansible.](lab8_ansible_jenkins/playbookok1.png)
...
![Zmodyfikowany plik main.yml jako element automatyzacji pipeline.](lab8_ansible_jenkins/mainyml.png)
...
![Poprawne przejście testów po konfiguracji automatyzacji.](lab8_ansible_jenkins/testpass.png)
...
![Sprawdzenie konfiguracji sieci przez nmcli przed pracą z Kickstart.](lab9_kickstart_jq/nmclipng.png)
...
![Transfer plików przez scp do środowiska instalacyjnego.](lab9_kickstart_jq/scp.png)
...
![Modyfikacja parametrów startowych instalatora pod automatyczne użycie Kickstart.](lab9_kickstart_jq/kernelmodify.png)
...
![Poprawne uruchomienie jq po przygotowaniu środowiska.](lab9_kickstart_jq/jqsuccess.png)

*Rys. 9. Poprawne uruchomienie jq po przygotowaniu środowiska.*

![Uruchomienie jq w środowisku runtime.](lab9_kickstart_jq/jqruntime.png)
...
![Uruchomienie lokalnego środowiska minikube.](lab10_kubernetes_rollout/minikub.png)

*Rys. 11. Uruchomienie lokalnego środowiska minikube.*

![Sprawdzenie statusu środowiska Kubernetes.](lab10_kubernetes_rollout/statuskuba.png)
...
![Plik deployment.yaml definiujący aplikację i jej repliki.](lab10_kubernetes_rollout/deploymentyaml.png)

*Rys. 13. Plik deployment.yaml definiujący aplikację i jej repliki.*

![Plik service.yaml wystawiający aplikację przez stabilny Service.](lab10_kubernetes_rollout/service.png)
...
![Lista podów po zwiększeniu liczby replik.](lab10_kubernetes_rollout/8pod.png)

*Rys. 15. Lista podów po zwiększeniu liczby replik.*

![Potwierdzenie poprawnego działania przy większej liczbie replik.](lab10_kubernetes_rollout/4repliksukces.png)
...
![Błędny stan poda po nieudanym wdrożeniu.](lab10_kubernetes_rollout/badpodfail.png)

*Rys. 17. Błędny stan poda po nieudanym wdrożeniu.*

![Udany rollback do działającej wersji deploymentu.](lab10_kubernetes_rollout/rollbaksukces.png)
...
![Test curl potwierdzający działanie scenariusza canary.](lab10_kubernetes_rollout/canarycurltest.png)
...
![Naprawione środowisko kubectl i możliwość wykonywania poleceń Kubernetes.](lab11_minikube_service_scaling/kubwctl.png)
...
![Uruchomienie nginx jako prostego poda testowego.](lab11_minikube_service_scaling/nginx.png)
...
![Skalowanie deploymentu i obserwacja zmian w liczbie podów.](lab11_minikube_service_scaling/podscale.png)

*Rys. 22. Skalowanie deploymentu i obserwacja zmian w liczbie podów.*

![Stan po ustawieniu ośmiu replik.](lab11_minikube_service_scaling/8replika.png)

*Rys. 23. Stan po ustawieniu ośmiu replik.*

![Stan po zmniejszeniu liczby replik do trzech.](lab11_minikube_service_scaling/3replica.png)
...
![Deklaratywny Deployment dla lab11-nginx-yaml.](lab11_minikube_service_scaling/deployment.png)

*Rys. 25. Deklaratywny Deployment dla lab11-nginx-yaml.*

![Deklaratywny Service typu ClusterIP dla aplikacji z labu 11.](lab11_minikube_service_scaling/serviceyaml.png)
